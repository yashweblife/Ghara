...
export default function Page() {
    return (
        <>
            ...
            <Hero>
                <Text className="text-3xl md:text-4xl text-shadow-xs drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]" bold center>
                    Take control of your <Bold text='Ghara' />
                </Text>
                <Text className='md:w-[45ch] text-gray-500 md:text-2xl text-shadow-xs drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)]' center responsive={false}>
            ...
            <Content>
                <div className='p-5 md:py-0 md:pb-5 -translate-y-10 z-10 flex flex-col gap-5'>
                    <CardHolder className='backdrop-blur-2xl bg-sky-900/20'>
                        <Text className='text-4xl w-full py-5' center bold>What We Offer</Text>
                        <Card>
                            <CardImage src={visualImage} />
                            <CardHeader>
                                <Text center responsive={false}>Visualize Your Weekly Spending</Text>
                            </CardHeader>
                            <CardContent>
                                <Text center responsive={false}>
                        ...
                        <Card>
                            ...
                            <CardHeader>
                                <Text center responsive={false}>Self Host An Instance</Text>
                            </CardHeader>
                            <CardContent>
                                <Text center responsive={false}>
                        ...
                        <Card>
                            ...
                            <CardHeader>
                                <Text center responsive={false}>Make your Grocery Lists</Text>
                            </CardHeader>
                            <CardContent>
                                <Text center responsive={false}>
